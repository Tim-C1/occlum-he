...
extern "C" {
    ...
    // sgx_edger8r.h
    //
    pub fn sgx_ocalloc_aligned(align: size_t, size: size_t) -> *mut c_void;
    pub fn sgx_ocremain_size() -> size_t;
    pub fn sgx_ecall_ms_buffer_alloc(eid: sgx_enclave_id_t, size: size_t) -> *mut c_void;
    pub fn sgx_ecall_ms_buffer_alloc_aligned(eid: sgx_enclave_id_t, align: size_t, size: size_t) -> *mut c_void;
    pub fn sgx_ecall_ms_buffer_free(eid: sgx_enclave_id_t) -> sgx_status_t;
    pub fn sgx_ecall_ms_buffer_remain_size(eid: sgx_enclave_id_t) -> size_t;
}
